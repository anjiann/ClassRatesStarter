...
function submitComment(commentControl) {
    ...
    var apiKey = "edb2f8b5c9ac4cac8ec2d2fc36a0e606";
    ...
    $.ajax({
      ...
      var sentimentRating = Math.round((result.documents[0].score * 100) / 25) + 1; //score is returned 0 to 1 we want to display from 0 to 5
